...
#define FIREBASE_HOST "https://teste-2-94a46-default-rtdb.firebaseio.com/"    
#define FIREBASE_AUTH "6WDrWvglLWZdyC5Wyxs17vAwyU7etLqgKKppnu0t"   
...
*/
  ...
  Firebase.setString("/quarto/dono", "Giuliana");
  ...
  delay(3000);
  Firebase.setString("/quarto/dono", "Gaybriel");
